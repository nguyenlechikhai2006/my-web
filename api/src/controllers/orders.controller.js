...
async function createOrder(req, res, next) {
  try {
    ...
    for (const it of items) {
      ...
      // CẬP NHẬT TẠI ĐÂY: Thêm selectedSize và selectedFlavor vào snapshot để lưu vô Mongoose
      snapshot.push({ 
        productId: p._id, 
        title: p.title, 
        price: p.price, 
        ...
        image: p.images?.[0],
        selectedSize: it.selectedSize || "N/A",  // Nhận từ web gửi sang
        selectedFlavor: it.selectedFlavor || "N/A" // Nhận từ web gửi sang
      });
    }
